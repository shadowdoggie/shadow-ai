...
const COMPACT_LIVE_BASE_SYSTEM_INSTRUCTION =
  ...
  'Subagent controls: use get_active_subagents when the user asks what background work is doing. If active_count is 0, recent subagent history is historical only; do not claim ongoing research/work. Use steer_subagent for user corrections and cancel_subagent for stop/cancel requests.\n\n' +
